...
{{-- <section class="bhrau-content-one">
<section class="text-white d-flex flex-column justify-content-center align-items-center" style="background-image: url(./images/image/banner.jpg); height: 50rem; background-size: cover; background-repeat: no-repeat;">
  <div class="container">
    <div class="row">
      <div class="col-12">
          <h1 class="display-4"><strong>BHRAU<br></strong> </h1>
      </div>
    </div>
  </div>
</section>
...
<section class="bhrau-content-two">
...
<section class="bhrau-content-three">
